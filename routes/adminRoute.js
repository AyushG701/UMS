...
admin_route.use(
  session({
    ...
    resave: false, // Set this option to avoid the deprecation warning
    saveUninitialized: false, // Set this option to avoid the deprecation warning
  }),
);
